...
int main() {
    ...
    animals.push_back(new Fish("Kaluga", 2, "Lake", false, false));
    animals.push_back(new Fish("Zander", 5, "River", true, false));
    animals.push_back(new Fish("Pike", 1, "Pond", true, true));

    animals.push_back(new Bird("Pigeon", 10, "City", true, false));
    animals.push_back(new Bird("Steppe eagle", 3, "Desert", false, false));
    animals.push_back(new Bird("Large frigate", 7, "In the middle of the ocean", true, true));

    animals.push_back(new Mammal("Horse", 8, "Home", true, true));
    animals.push_back(new Mammal("Monkey", 4, "Forest", false, true));
    animals.push_back(new Mammal("Whale", 6, "Sea", true, false));
